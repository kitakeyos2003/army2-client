...
public class TField {
    ...
    public void setOffset() {
        ...
        if (this.offsetX < 0 && mFont.tahoma_8b_brown.getWidth(this.paintedText) + this.offsetX < this.width - 4 - 13 - TField.typingModeAreaWidth) {
            this.offsetX = this.width - 10 - TField.typingModeAreaWidth - mFont.tahoma_8b_brown.getWidth(this.paintedText);
        }
        if (this.offsetX + mFont.tahoma_7_white.getWidth(this.paintedText.substring(0, this.caretPos)) <= 0) {
            ...
            this.offsetX += 40;
        } else if (this.offsetX + mFont.tahoma_8b_brown.getWidth(this.paintedText.substring(0, this.caretPos)) >= this.width - 12 - TField.typingModeAreaWidth) {
            this.offsetX = this.width - 10 - TField.typingModeAreaWidth - mFont.tahoma_8b_brown.getWidth(this.paintedText.substring(0, this.caretPos)) - 8;
        }
        if (this.offsetX > 0) {
            this.offsetX = 0;
        }
