...
public class Smoke {
    ...
    public Smoke(int xF, final int yF, final int xT, final int yT, final int typeLazer) {
        this.isStop = false;
        this.xLazer = xF;
        this.yLazer = yF;
        this.x = xT;
    ...
    public Smoke(int xF, final int yF, final int xT, final int yT) {
        this.isStop = false;
        this.x = xF;
        this.y = yF;
        this.xBat = xT;
    ...
    public Smoke(int x, final int y, final byte Type) {
        this.isStop = false;
        this.x = x;
        this.y = y;
        ...
        switch (this.type = Type) {
            case 0: {
                this.frmImg = Smoke.frameImages[Type];
                break;
            }
            case 19: {
    ...
    public Smoke(int x, final int y, final int vx, final int vy, final byte Type) {
        this.isStop = false;
        this.x = x;
        this.y = y;
        this.vx = vx;
    ...
    public static int checkWay(int x, final int y, final int xTo, final int yTo) {
        int L = 0;
        int R = 1;
        int U = 2;
        int D = 3;
    ...
    public void update() {
        switch (this.type) {
            ...
            case 18: {
                for (int i = 0; i < this.num; ++i) {
                    int[] smokeX = this.smokeX;
                    int n = i;
                    int[] array = smokeX;
                    int n3 = n;
                    array[n3] += this.vx;
                    int[] smokeY = this.smokeY;
                    int n2 = i;
                    int[] array2 = smokeY;
                    int n4 = n2;
                    array2[n4] += this.vy;
    ...
    public void paintEffect(mGraphics g) {
        switch (this.type) {
            ...
            case 2: {
                g.drawImage(Smoke.rockImg, this.x, this.y, mGraphics.HCENTER | mGraphics.VCENTER, false);
                break;
            }
            case 20: {
                g.drawImage(Smoke.star, this.x, this.y, mGraphics.HCENTER | mGraphics.VCENTER, false);
                break;
            }
            case 3: {
                this.frmImg.drawFrame(this.curFrame, this.x, this.y, 0, mGraphics.HCENTER | mGraphics.VCENTER, g);
            ...
            case 5: {
                for (int i = 0; i < this.num; ++i) {
                    int dark = CRes.random(this.smokeHeight - 20, this.smokeHeight);
    ...
    static {
        try {
            Smoke.filePack = new FilePack(CCanvas.getClassPathConfig(String.valueOf(CONFIG.PATH_EFFECT) + "effect"));
            Smoke.smoke = Smoke.filePack.loadImage("smoke.png", new IAction2() {
                @Override
            ...
            Smoke.smoke2 = Smoke.filePack.loadImage("smoke2.png", new IAction2() {
                @Override
                public void perform(Object object) {
            ...
            Smoke.chickenHair = Smoke.filePack.loadImage("longga.png", new IAction2() {
                @Override
                public void perform(Object object) {
            ...
            Smoke.blackSmokeImg = Smoke.filePack.loadImage("blacksmoke.png", new IAction2() {
                @Override
                public void perform(Object object) {
            ...
            Smoke.blueSmoke = Smoke.filePack.loadImage("blueSmoke.png", new IAction2() {
                @Override
                public void perform(Object object) {
            ...
            Smoke.chuotBay = Smoke.filePack.loadImage("chuotbay.png", new IAction2() {
                @Override
                public void perform(Object object) {
            ...
            Smoke.gatruilong = Smoke.filePack.loadImage("gatruilong.png", new IAction2() {
                @Override
                public void perform(Object object) {
            ...
            Smoke.water = Smoke.filePack.loadImage("water.png", new IAction2() {
                @Override
                public void perform(Object object) {
            ...
            Smoke.imgTornado = Smoke.filePack.loadImage("locxoay.png", new IAction2() {
                @Override
                public void perform(Object object) {
                    CRes.onSaveToFile((Image) object, "locxoay", true);
                }
            });
            Smoke.explode = Smoke.filePack.loadImage("ex3.png", new IAction2() {
                @Override
                public void perform(Object object) {
                    CRes.onSaveToFile((Image) object, "ex3", true);
                }
            });
            Smoke.lacay = Smoke.filePack.loadImage("lacay.png", new IAction2() {
                @Override
                public void perform(Object object) {
            ...
            Smoke.lazerSmoke = Smoke.filePack.loadImage("blueSmoke2.png", new IAction2() {
                @Override
                public void perform(Object object) {
            ...
            Smoke.glassFly2 = Smoke.filePack.loadImage("lacay2.png", new IAction2() {
                @Override
                public void perform(Object object) {
            ...
            Smoke.smokeNuke = Smoke.filePack.loadImage("khoi.png", new IAction2() {
                @Override
                public void perform(Object object) {
            ...
            Smoke.smokeFire = Smoke.filePack.loadImage("smokeFire.png", new IAction2() {
                @Override
                public void perform(Object object) {
            ...
            Smoke.lua = Smoke.filePack.loadImage("lua.png", new IAction2() {
                @Override
                public void perform(Object object) {
                    CRes.onSaveToFile((Image) object, "lua", true);
                }
            });
            Smoke.filePack = new FilePack(CCanvas.getClassPathConfig(String.valueOf(CONFIG.PATH_MAP) + "bg"));
            Smoke.rockImg = Smoke.filePack.loadImage("rock1.png", new IAction2() {
                @Override
                public void perform(Object object) {
                    CRes.onSaveToFile((Image) object, "Smoke_ rock1");
                }
            });
            Smoke.rock2Img = Smoke.filePack.loadImage("rock2.png", new IAction2() {
                @Override
                public void perform(Object object) {
            ...
            Smoke.glassFly = Smoke.filePack.loadImage("cobay.png", new IAction2() {
                @Override
                public void perform(Object object) {
            ...
            Smoke.bat = mImage.createImage("/effect/bat.png");
            Smoke.star = mImage.createImage("/effect/star.png");
            Smoke.wind = mImage.createImage("/effect/locxoay.png");
        } catch (Exception e) {
            e.printStackTrace();
        }
        Smoke.filePack = null;
        Smoke.frameImages = new FrameImage[22];
    }
}
