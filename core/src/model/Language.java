...
public class Language {
    ...
    public static final String[][] tenQuanHam = new String[][] { { "Sơ cấp 1", "Sơ cấp 2", "Sơ cấp 3", "Sơ cấp 4",
            "Trung cấp 1", "Trung cấp 2", "Trung cấp 3", "Trung cấp 4", "Cao cấp 1", "Cao cấp 2", "Cao cấp 3",
            "Cao cấp 4", "Siêu cấp 1", "Siêu cấp 2", "Siêu cấp 3", "Siêu cấp 4" } };
    public static final String[] training1 = new String[] { "Xin chào các bạn đến với phần luyện tập của MOBIARMY." };
    public static final String[] training2 = new String[] {
            "Dùng các phím mũi tên qua lại để điều khiển nhân vật. Hãy thử xem." };
    public static final String[] training3 = new String[] {
            "Thanh lực màu xanh bên dưới cho biết quãng đường bạn có thể đi." };
    public static final String[] training4 = new String[] {
            "Dùng các phím mũi tên lên xuống để nhắm. Nhấn và giữ phím giữa để canh lực và bắn." };
    public static final String[] training5 = new String[] { "Hãy cố gắng bắn rơi tên lính đối thủ của bạn." };
    public static final String[] training6 = new String[] {
            "Khi bạn bị bắn hết máu. Bạn có thể chọn mục Dùng Item từ MENU. Hãy thử bơm máu" };
    public static final String[] training7 = new String[] {
            "Xin chúc mừng. Bạn đã có thể tham gia cuộc chiến ngay bây giờ. Còn chờ gì nữa?" };
    public static final String[] makeFriend = new String[] { "Kết bạn", "Make friends" };
    public static final String[][] items = new String[][] { { "Phục hồi HP", "Teleport", "Bắn x2", "Di chuyển x2",
            "Tàng hình", "Ngưng gió", "Bom phá đất", "Lựu đạn", "Bom hủy diệt", "Tơ nhện", "HP đồng đội",
            "Đạn trái phá", "Túi đựng item 1", "Túi đựng item 2", "Túi đựng item 3", "Túi đựng item 3", "Đạn Lazer",
            "Đạn vòi rồng", "Chuột gắn bom", "Tên lửa", "Đạn xuyên đất", "Sao băng", "Mưa đạn", "Khoang đất", "Tự sát",
            "Bom mù", "Khoang đất 2", "UFO", "Đóng băng", "Khói độc", "Tơ nhện 2", "Bom hẹn giờ", "HP 50%", "HD 100%",
            "Vô hình", "Ma cà rồng", "Rock man", "Cyber girl" } };
    ...
    public static final String[][] top = new String[][] {
            { "TOP ĐẠI GIA", "BẢNG THÀNH TÍCH", "DANH SÁCH BẠN BÈ", "DANH SÁCH MỜI BẠN" } };
    ...
    public static final String[] justSent = new String[] {
            "Bạn vừa gửi tin. Xin chờ giây lát để có thể gửi thêm một tin nữa" };
    ...
    public static final String[] email_phoneRegPlease = new String[] {
            "Bạn phải nhập email hoặc số điện thoại đăng ký." };
    ...
    public static final String[] sendSMS = new String[] {
            "Đã gửi thông tin đăng ký thành công. Xin thoát game và chờ giây lát." };
    public static final String[] sendSMSFail = new String[] {
            "Không thể gởi tin nhắn. Xin kiểm tra tiền và thử khởi động lại game." };
    ...
    public static final String[] autoOpen = new String[] {
            "Nếu điện thoại không tự mở trình duyệt, xin vui lòng tắt Mobi Army" };
    ...
    public static final String[] usingPhone = new String[] {
            "Có phải bạn đang dùng số điện thoại đăng ký tài khoản không?",
            "Are you using the phone number to register your account?" };
    public static final String[] usingPhone2 = new String[] {
            "Bạn phải dùng số điện thoại đăng ký tài khoản để lấy lại mật khẩu." };
    public static final String[] Question = new String[] {
            "Một số máy cần thoát game để thực hiện thao tác này. bạn muốn thoát không?" };
    ...
    public static final String[] sendMoneySucc = new String[] {
            "Đã nạp tiền xong. Xin chờ tin nhắn xác nhận. Lưu ý bạn chỉ nạp được 3 lần trong 5 phút." };
    ...
    public static final String md_String_1() {
        return sendSuccess[language];
    }
