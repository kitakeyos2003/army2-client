...
public class PauseMenu {
    ...
    public void startAt(Vector<Command> menuItems) {
        int dis = CCanvas.isTouch ? 30 : 24;
        this.menuItems = menuItems;
        this.menuW = 0;
        this.menuH = 0;
        for (int i = 0; i < menuItems.size(); ++i) {
            Command c = menuItems.elementAt(i);
    ...
    public void paint(mGraphics g) {
        ...
        for (int i = 0; i < this.menuItems.size(); ++i) {
            ...
            Font.bigFont.drawString(g, ((Command) this.menuItems.elementAt(i)).caption, CCanvas.hw,
                    this.menuY + i * dis, 2);
        }
    }
